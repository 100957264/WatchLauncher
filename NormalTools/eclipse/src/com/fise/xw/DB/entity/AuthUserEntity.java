 ...
 * 授权人信息
 */
public class AuthUserEntity extends PeerEntity {
	...
	public AuthUserEntity(Long id) {
		this.id = id;
	}

	public AuthUserEntity(Long id, int peerId, int gender, String mainName,
			...
			int Search_allow, String groupNick,int devId) {
		this.id = id;
		this.peerId = peerId;
		this.gender = gender;
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof AuthUserEntity))
			return false;

		AuthUserEntity entity = (AuthUserEntity) o;
