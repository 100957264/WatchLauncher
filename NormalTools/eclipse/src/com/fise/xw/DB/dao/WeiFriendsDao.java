 ...
 * 位友表
*/
public class WeiFriendsDao extends AbstractDao<UserEntity, Long> {

    public static final String TABLENAME = "WeiFriendsDao";
    ...
    */
    ...
    public WeiFriendsDao(DaoConfig config) {
        super(config);
    }
    
    public WeiFriendsDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'WeiFriendsDao' (" + //
        ...
        // Add Indexes 
        db.execSQL("CREATE INDEX " + constraint + "IDX_WeiFriendsDao_PEER_ID ON WeiFriendsDao" +
                " (PEER_ID);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'WeiFriendsDao'";
        db.execSQL(sql);
    }
