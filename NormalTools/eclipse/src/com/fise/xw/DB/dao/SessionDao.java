...
public class SessionDao extends AbstractDao<SessionEntity, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property muteNotification = new Property(10, int.class, "muteNotification", false, "MUTENOTIFICATION");
        public final static Property stickyOnTop = new Property(11, int.class, "stickyOnTop", false, "STICKYONTOP");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'Session' (" + //
                ...
                "'MUTENOTIFICATION' INTEGER NOT NULL ," + // 10: muteNotification 
                "'STICKYONTOP' INTEGER NOT NULL );"); // 11: stickyOnTop
    }
    ...
    public SessionEntity readEntity(Cursor cursor, int offset) {
        SessionEntity entity = new SessionEntity( //
            ...
            cursor.getInt(offset + 10), // muteNotification 
            cursor.getInt(offset + 11) // stickyOnTop 
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, SessionEntity entity, int offset) {
        ...
        entity.setMuteNotification(cursor.getInt(offset + 10)); 
        entity.setStockOnTop(cursor.getInt(offset + 11)); 
     }
