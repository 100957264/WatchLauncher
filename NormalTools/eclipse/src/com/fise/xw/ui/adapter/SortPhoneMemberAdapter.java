...
public class SortPhoneMemberAdapter extends BaseAdapter implements SectionIndexer   {
	...
	public View getView(final int position, View view, ViewGroup arg2) {
		...
		if (view == null) {
			...
			view = LayoutInflater.from(mContext).inflate(R.layout.activity_phone_member_item, null);
		...
		viewHolder.xiaoWei.setText("小位:" + this.list.get(position).getUserEntity().getMainName());
        ...
        if(this.list.get(position).getUserEntity().getIsFriend() == 0)
        {
