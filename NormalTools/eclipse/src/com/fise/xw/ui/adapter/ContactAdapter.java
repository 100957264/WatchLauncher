...
public class ContactAdapter extends BaseAdapter implements SectionIndexer,
	...
	public int getPositionForSection(int section) {
		...
		int index = userList == null ? 0 : userList.size();
	...
	public int getItemViewType(int position) {
		...
		if (position == 0) {
			return ContactType.NEWFRIENDS.ordinal();
		} else if (position == 1) {
	...
	public Object getItem(int position) {
		...
		case NEWFRIENDS: {
			/*
			 * int groupSize = groupList==null?0:groupList.size(); int realIndex
			 * = position - groupSize; if(realIndex <0){ throw new
			 * IllegalArgumentException("ContactAdapter#getItem#user类型判断错误!"); }
	...
	public View renderNewFunc(int position, View view, ViewGroup parent) {
		if (view == null) {
			...
			// (RelativeLayout)view.findViewById(R.id.searchInformation);
			// information.setOnClickListener(new OnClickListener() {
			//
			// @Override
			// public void onClick(View v) {
			// // TODO Auto-generated method stub
			// IMUIHelper.openSearchFriendActivity(ctx,DBConstant.SEACHFRIENDS);
			//
			// }
			// });
	...
	public View renderFunc(int position, View view, ViewGroup parent) {
		...
		RelativeLayout wei_friends_view = (RelativeLayout) view
				.findViewById(R.id.wei_friends_view);
		wei_friends_view.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				IMUIHelper.openStarActivity(ctx);

			}
		});

		RelativeLayout wei_group_view = (RelativeLayout) view
				.findViewById(R.id.wei_group_view);
		wei_group_view.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				IMUIHelper.openWeiGroupActivity(ctx);
