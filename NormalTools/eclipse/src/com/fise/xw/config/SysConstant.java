...
public interface SysConstant {
    ...
    public static final String UPLOAD_IMAGE_INTENT_PARAMS = "com.fise.xw.upload.image.intent";
    public static final String UPLOAD_IMAGE_INTENT_PARAMS_AVATAR = "com.fise.xw.upload.image.avatar.intent";
    public static final String UPLOAD_VEDIO_INTENT_PARAMS = "com.fise.xw.upload.vedio.intent";
    public static final String UPLOAD_IMAGE_END_INTENT_PARAMS = "com.fise.xw.upload.image.end.intent";
    public static final String UPLOAD_IMAGE_INTENT_TYPE_AVATAR = "com.fise.xw.upload.image.type.intent";
