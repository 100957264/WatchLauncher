...
import com.fise.xw.imservice.callback.ListenerQueue;
import com.fise.xw.imservice.callback.Packetlistener;
import com.fise.xw.imservice.event.SocketEvent;
import com.fise.xw.imservice.network.MsgServerHandler;
import com.fise.xw.imservice.network.RegistMsgServerHandler;
import com.fise.xw.imservice.network.RegistSmsServerHandler;
import com.fise.xw.imservice.network.SocketThread;
import com.fise.xw.protobuf.IMBaseDefine;
import com.fise.xw.protobuf.IMOther;
import com.fise.xw.protobuf.base.DataBuffer;
import com.fise.xw.protobuf.base.DefaultHeader;
...
public class IMSocketManager extends IMManager {
    ...
    public void sendRequest(GeneratedMessageLite requset,int sid,int cid,Packetlistener packetlistener){
        ...
        try{
            //组装包头 header
            com.fise.xw.protobuf.base.Header header = new DefaultHeader(sid, cid);
    ...
    public void packetDispatch(ChannelBuffer channelBuffer){
        ...
        com.fise.xw.protobuf.base.Header header = new com.fise.xw.protobuf.base.Header();
    ...
    public void reqMsgServerAddrs() {
        ...
        client.get(SystemConfigSp.instance().getStrConfig(SystemConfigSp.SysCfgDimension.LOGINSERVER), new BaseJsonHttpResponseHandler(){
            ...
            public void onSuccess(int i, Header[] headers, String s, Object o) {
                ...
                if(msgServer == null){
                    triggerEvent(SocketEvent.REQ_MSG_SERVER_ADDRS_FAILED);  //请求失败
                    return;
                }
    ...
    public void SmsServerAddrs() {
        ...
        client.get(SystemConfigSp.instance().getStrConfig(SystemConfigSp.SysCfgDimension.LOGINSERVER), new BaseJsonHttpResponseHandler(){
            ...
            public void onSuccess(int i, Header[] headers, String s, Object o) {
                ...
                MsgServerAddrsEntity msgServer = (MsgServerAddrsEntity) o;
                if(msgServer == null){
                    triggerEvent(SocketEvent.REQ_MSG_SERVER_SMS_FAILED);  //请求失败
                    return;
                }
                registerSmsServer(msgServer);
    ...
    private MsgServerAddrsEntity onRepLoginServerAddrs(JSONObject json)
     ...
     //   String priorIP = "218.18.232.202";// "218.18.232.202";//json.getString("priorIP"); //
      //  String backupIP =  "218.18.232.202";// "218.18.232.202";//json.getString("backupIP"); 
       //        
        ...
        //   String msfsPrior = "http://218.18.232.202:8700/";// "http://218.18.232.202:8700/";// json.getString("msfsPrior");//
        //   String msfsBackup = "http://218.18.232.202:8700/";//"http://218.18.232.202:8700/";//json.getString("msfsBackup");// 
