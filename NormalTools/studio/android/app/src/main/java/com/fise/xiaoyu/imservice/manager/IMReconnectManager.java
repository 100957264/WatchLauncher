...
public class IMReconnectManager extends IMManager {
    ...
    private final int INIT_RECONNECT_INTERVAL_SECONDS = 5;
    private int reconnectInterval = INIT_RECONNECT_INTERVAL_SECONDS;
    private final int MAX_RECONNECT_INTERVAL_SECONDS = 12000; //120000
    ...
    /**--------------------boradcast-广播相关-----------------------------*/
    private final String  ACTION_RECONNECT = "com.fise.xiaoyu.imlib.action.reconnect";
