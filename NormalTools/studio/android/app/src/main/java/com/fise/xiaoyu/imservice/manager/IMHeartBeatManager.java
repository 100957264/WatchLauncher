...
import com.fise.xiaoyu.protobuf.IMOther;
 ...
 */
@SuppressLint("NewApi") public class IMHeartBeatManager  extends  IMManager{
    // 心跳检测4分钟检测一次，并且发送心跳包
    ...
    private final String ACTION_SENDING_HEARTBEAT = "com.fise.xiaoyu.imservice.manager.imheartbeatmanager";
