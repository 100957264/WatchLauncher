...
public class UserFriendsDao extends AbstractDao<WeiEntity, Long> {

    public static final String TABLENAME = "UserReqInfo";
    ...
    */
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'UserReqInfo' (" + //
        ...
        // Add Indexes 
        db.execSQL("CREATE INDEX " + constraint + "IDX_UserReqInfo_PEER_ID ON UserReqInfo" +
                " (FROM_ID);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'UserReqInfo'";
        db.execSQL(sql);
    }
