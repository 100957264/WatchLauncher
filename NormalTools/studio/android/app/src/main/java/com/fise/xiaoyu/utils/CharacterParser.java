...
public class CharacterParser {  
    ...
    private int getChsToAscii(String chs) {  
        int asc = 0;  
        try {  
            ...
            Logger.getLogger(MsgAnalyzeEngine.class).e(e.getMessage());
        }  
        return asc;  
    }  
  
    public String convertChs(String str) {  
        String result = null;  
        int ascii = getChsToAscii(str);  
