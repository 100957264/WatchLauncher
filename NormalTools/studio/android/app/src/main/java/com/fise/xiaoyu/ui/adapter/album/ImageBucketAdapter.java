...
package com.fise.xiaoyu.ui.adapter.album;
...
import com.fise.xiaoyu.ui.adapter.album.BitmapCache.ImageCallback;
...
//                holder.count.setTextColor(R.color.album_list_item_count_color);
                holder.count.setTextColor(act.getResources().getColor(R.color.album_list_item_count_color));
            }
            return convertView;
        } catch (Exception e) {
            logger.e(e.getMessage());
