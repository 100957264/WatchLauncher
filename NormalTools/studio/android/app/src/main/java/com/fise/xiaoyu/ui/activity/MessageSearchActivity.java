...
public class MessageSearchActivity extends TTBaseActivity implements
    ...
    public void showToast(int resId) {
        ...
        if (mToast == null) {
            mToast = Utils.getToast(MessageSearchActivity.this, text);
        } else {
            mToast.setText(text);
    ...
    public void addFriendsOthersPanelView() {
        ...
        viewPager = (ViewPager) MessageSearchActivity.this.findViewById(R.id.viewpager);
        LayoutInflater lf = getLayoutInflater().from(MessageSearchActivity.this);
        ...
        takePhotoBtn.setOnClickListener(MessageSearchActivity.this);

        View take_camera_btn = view1.findViewById(R.id.take_camera_btn);
        take_camera_btn.setOnClickListener(MessageSearchActivity.this);


        View take_vedio_btn = view1.findViewById(R.id.take_vedio_btn);
        take_vedio_btn.setOnClickListener(MessageSearchActivity.this);

        View take_mingpian_btn = view1.findViewById(R.id.take_mingpian_btn);
        take_mingpian_btn.setOnClickListener(MessageSearchActivity.this);


        RelativeLayout take_postion_view = (RelativeLayout) (view1.findViewById(R.id.take_postion_view));
        take_postion_view.setOnClickListener(MessageSearchActivity.this);

        RelativeLayout rl_phone_callback_btn = (RelativeLayout) (view1.findViewById(R.id.rl_phone_callback_btn));
        // rl_phone_callback_btn.setOnClickListener(MessageSearchActivity.this);

        View phone_callback_btn = view1.findViewById(R.id.phone_callback_btn);
        phone_callback_btn.setOnClickListener(MessageSearchActivity.this);

        View take_position_btn = view1.findViewById(R.id.take_position_btn);
        take_position_btn.setOnClickListener(MessageSearchActivity.this);
    ...
    public void setAddOthersPanelView() {
        ...
        LayoutInflater lf1 = getLayoutInflater().from(MessageSearchActivity.this);
        ...
        LinearLayout bottom_dots = (LinearLayout) (MessageSearchActivity.this.findViewById(R.id.bottom_dots));
        ...
        take_photo_btn.setOnClickListener(MessageSearchActivity.this);
        ...
        check_position_btn.setOnClickListener(MessageSearchActivity.this);

        View take_zhua_photo_btn = view1.findViewById(R.id.take_zhua_photo_btn);
        take_zhua_photo_btn.setOnClickListener(MessageSearchActivity.this);

        View take_recordings_btn = view1.findViewById(R.id.take_recordings_btn);
        take_recordings_btn.setOnClickListener(MessageSearchActivity.this);
        ...
        check_telephone_charge.setOnClickListener(MessageSearchActivity.this);
...
//                if ((user!=null)&&user.getUserType() == IMBaseDefine.ClientType.CLIENT_TYPE_FISE_MONITOR_VALUE) {
//                    mLlDevicePanel = (LinearLayout) findViewById(R.id.add_camera_device_panel);
//                }else if(user!=null){
...
//            }
        ...
        TextView takePositionText = (TextView) findViewById(R.id.take_position_text);
        ...
        View videoOnline = findViewById(R.id.video_online_btn);
        View videoOnlineView = findViewById(R.id.video_online_view);
        View check_position_btn = findViewById(R.id.check_position_btn);
        //1
        View check_telephone_charge = findViewById(R.id.check_telephone_charge);
        View phone_callback_btn = findViewById(R.id.phone_callback_btn);
        //2
        View  rl_phone_callback_btn = findViewById(R.id.rl_phone_callback_btn);
        View rl_check_telephone_charge = findViewById(R.id.rl_check_telephone_charge);

        View kong_View1 = findViewById(R.id.take_kong_view1);
        View kong_View2 = findViewById(R.id.take_kong_view2);
        View kong_View3 = findViewById(R.id.take_kong_view3);
        ...
        check_position_btn.setOnClickListener(this);
        check_telephone_charge.setOnClickListener(this);
        phone_callback_btn.setOnClickListener(this);
        ...
        View check_postion_view = findViewById(R.id.check_postion_view);
...
////                videoOnlineView.setVisibility(View.GONE);
//                kong_View1.setVisibility(View.VISIBLE);
//                kong_View2.setVisibility(View.VISIBLE);
//                kong_View3.setVisibility(View.VISIBLE);
...
//                kong_View1.setVisibility(View.GONE);
//                kong_View2.setVisibility(View.GONE);
//                take_postion_view.setVisibility(View.VISIBLE);
//                check_postion_view.setVisibility(View.VISIBLE);
//                kong_View3.setVisibility(View.GONE);
//                take_recordings_view.setVisibility(View.GONE);
//                take_zhua_photo_view.setVisibility(View.GONE);
//                rl_phone_callback_btn.setVisibility(View.VISIBLE);
//                rl_check_telephone_charge.setVisibility(View.VISIBLE);
            }
...
//
//                if (user.getGroupType() == DBConstant.GROUP_TYPE_FAMILY) {
//                    hideBottom();
//                }
//            } else {
...
//            }
            ...
            if ((peerUser != null) && (peerUser.getIsFriend() == DBConstant.FRIENDS_TYPE_YUYOU)) {
...
//
//
////                videoOnlineView.setVisibility(View.VISIBLE);
//                kong_View2.setVisibility(View.VISIBLE);  //位友GONE　kong_View2
//
//
//                kong_View3.setVisibility(View.VISIBLE);
//                kong_View1.setVisibility(View.GONE);
...
//
//
//                kong_View1.setVisibility(View.VISIBLE); //位友GONE　kong_View1
                // kong_View1.setVisibility(View.VISIBLE);
        ...
        switch (peerType) {
            case DBConstant.SESSION_TYPE_GROUP: {
                ...
                if (!memberLists.contains(loginUser.getPeerId())) {
                    ...
                    Utils.showToast(MessageSearchActivity.this, R.string.no_group_member);
                    // add  gzc
                    hideRightButton();
                }
            ...
            case DBConstant.SESSION_TYPE_SINGLE: {
                ...
                topTitleTxt.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        // guanweile
                        IMUIHelper.openUserProfileActivity(MessageSearchActivity.this,
    ...
    public void onMessageEvent(PriorityEvent event) {
        switch (event.event) {
            ...
            case MSG_VEDIO_ONLINE_DEV_START: {
                ...
                if (info != null) {
                    Intent intent1 = new Intent(MessageSearchActivity.this, HosterActivity.class);
                    ...
                    MessageSearchActivity.this.startActivity(intent1);
                }
    ...
    public void onMessageEvent(UserInfoEvent event) {
        switch (event) {
            ...
            case USER_P2PCOMMAND_ONLINE:
                Utils.showToast(MessageSearchActivity.this, "你的请求已发送,请稍候");
                break;
...
//                TextMessage bellTextMessage = TextMessage.buildForSend(bellContent,
//                        loginUser, peerEntity);
//                imService.getMessageManager().sendText(bellTextMessage);
//                messageEdt.setText("");
//                pushList(bellTextMessage);
//                scrollToBottomListItem();

//                break;

//            case USER_COMMAND_TYPE_DEVICE_CURRENT_ACTIVITY:

//                String posContent = "查询"+peerEntity.getMainName()+"位置";
//                TextMessage posTextMessage = TextMessage.buildForSend(posContent,
//                        loginUser, peerEntity);
...
//                break;
            ...
            case USER_INFO_REQ_FRIENDS_FAIL:
                Utils.showToast(MessageSearchActivity.this, "请求加好友失败");
                break;

            case USER_COMMAND_TYPE_TAKE_PHOTO:
                Utils.showToast(MessageSearchActivity.this, "发送成功");
                break;
            ...
            case USER_MESSAGE_DATA_FAIL:
                Utils.showToast(MessageSearchActivity.this, "网络异常,获取消息失败");
                break;
    ...
    public void onMessageEvent(GroupEvent event) {
        switch (event.getEvent()) {
            ...
            case USER_GROUP_DELETE_SUCCESS: {
                GroupEntity groupEntity = event.getGroupEntity();
                if (peerEntity.getPeerId() == groupEntity.getPeerId()) {
                    Utils.showToast(MessageSearchActivity.this, getString(R.string.exit_group_hint_word));
                    this.finish();
                }
            }
            break;
...
//        camera_video_replay_btn = (View) this.findViewById(R.id.camera_video_replay_btn);
//        camera_video_replay_btn.setOnClickListener(new View.OnClickListener() {
//
//            @Override
//            public void onClick(View v) {
...
//
//                imService.getUserActionManager().UserP2PCommand(IMLoginManager.instance().getLoginId(), peerEntity.getPeerId(),
...
//                }
                ...
                Rect r = new Rect();
                MessageSearchActivity.this.getWindow().getDecorView().getWindowVisibleDisplayFrame(r);
                //获取屏幕的高度
                int screenHeight = MessageSearchActivity.this.getWindow().getDecorView().getRootView().getHeight();
...
//                        }
            ...
            case R.id.take_photo_btn: {
                if (albumList.size() < 1) {
                    Utils.showToast(MessageSearchActivity.this,
            ...
            case R.id.take_camera_btn: {
                ...
                CompatUtil.startActionCapture(MessageSearchActivity.this, file, SysConstant.CAMERA_WITH_DATA);
...
//                break;
            ...
            case R.id.take_position_btn: {
                ...
                intent.setClass(MessageSearchActivity.this, MessagePostionActivity.class);
                intent.putExtra(IntentConstant.KEY_SESSION_KEY, currentSessionKey);
                MessageSearchActivity.this.startActivity(intent);
            ...
            case R.id.take_mingpian_btn: { // 名片
                Intent intent = new Intent();
                intent.setClass(MessageSearchActivity.this, FriendsSelectActivity.class);
                intent.putExtra(IntentConstant.KEY_SESSION_KEY, currentSessionKey);
                MessageSearchActivity.this.startActivity(intent);
                    ...
                    if (groupEntity.getGroupType() == DBConstant.GROUP_TYPE_FAMILY) {
                        ...
                        if (user != null) {
                            ...
                            imService.getUserActionManager().UserP2PCommand(formId, toId,
                                    ...
                                    IMBaseDefine.CommandType.COMMAND_TYPE_TAKE_PHOTO, "", true);
                        }
                    }
                    ...
                    if (groupEntity.getGroupType() == DBConstant.GROUP_TYPE_FAMILY) {
                        ...
                        if (user != null) {
                            if (TimeStart == 0) {
                                ...
                                imService.getUserActionManager().UserP2PCommand(formId, toId,
                                        IMBaseDefine.SessionType.SESSION_TYPE_SINGLE,
                                        IMBaseDefine.CommandType.COMMAND_TYPE_SOUND_COPY, "", true);
                            } else {
                                Utils.showToast(MessageSearchActivity.this, "请勿频繁操作");
                            }
                        }
                    }
                }
            ...
            case R.id.check_position_btn:   //同步数据
                ...
                if (peerEntity.getType() == DBConstant.SESSION_TYPE_GROUP) {
                    ...
                    if (groupEntity.getGroupType() == DBConstant.GROUP_TYPE_FAMILY) {
                        UserEntity user = getUserEntityFromGroupEntity(groupEntity);
                        if (user != null) {
//                                    if(user.getOnLine() == DBConstant.ONLINE){
//
//                                    }else{
...
//                                    }
                            if (TimeStart == 0) {
                                ...
                                IMUserActionManager.instance().UserP2PCommand(
                                        ...
                                        user.getPeerId(),
                                        IMBaseDefine.SessionType.SESSION_DEVICE_SINGLE, // SESSION_TYPE_SINGLE
                                        IMBaseDefine.CommandType.COMMAND_TYPE_DEVICE_CURRENT_INFO, "", false);
...
//                            }
                        if (userEntity.getPhone().equals("")) {
                            Utils.showToast(MessageSearchActivity.this, "设备未设置号码");
                            ...
                            if (TimeStart == 0) {
                                ...
                                IMUserActionManager.instance().UserP2PCommand(
                                        ...
                                        userEntity.getPeerId(),
                                        IMBaseDefine.SessionType.SESSION_DEVICE_SINGLE, // SESSION_TYPE_SINGLE
                                        IMBaseDefine.CommandType.COMMAND_TYPE_DEVICE_CALLBACK, loginUser.getPhone() + "", false);
                            } else {
                                Utils.showToast(MessageSearchActivity.this, "请勿频繁操作");
                            }
                        }
...
//                        }
                        if (TimeStart == 0) {
                            ...
                            imService.getUserActionManager().UserP2PCommand(
                                    ...
                                    userEntity.getPeerId(),
                                    IMBaseDefine.SessionType.SESSION_DEVICE_SINGLE, // SESSION_TYPE_SINGLE
                                    IMBaseDefine.CommandType.COMMAND_TYPE_DEVICE_BILL,
                                    "101", true);
                        } else {
                            Utils.showToast(MessageSearchActivity.this, "请勿频繁操作");
                        }
...
//        scrollToBottomListItem();
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (id == R.id.record_voice_btn) {
            if (event.getAction() == MotionEvent.ACTION_DOWN) {
                ...
                recordAudioBtn.setText(MessageSearchActivity.this.getResources()
                ...
                recordAudioBtn.setBackgroundResource(R.drawable.tt_pannel_btn_voiceforward_normal);
                recordAudioBtn.setText(MessageSearchActivity.this.getResources().getString(
    ...
    private void actFinish() {
        ...
        //跳到MainActivity
        Intent intent = new Intent(MessageSearchActivity.this, MainActivity.class);
    ...
    private OnEmoGridViewItemClick onEmoGridViewItemClick = new OnEmoGridViewItemClick() {
        ...
        public void onItemClick(int facesPos, int viewIndex) {
            ...
            if (deleteId > Emoparser.getInstance(MessageSearchActivity.this).getResIdList().length) {

                deleteId = Emoparser.getInstance(MessageSearchActivity.this).getResIdList().length;
            }
            ...
            if (deleteId == facesPos) {
                ...
                String pharse = Emoparser.getInstance(MessageSearchActivity.this)
...
//                    mLlDevicePanel.setVisibility(View.GONE);
                    ...
                    MessageSearchActivity.this.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_NOTHING);
//                    if (addOthersPanelView.getVisibility() == View.GONE) {
