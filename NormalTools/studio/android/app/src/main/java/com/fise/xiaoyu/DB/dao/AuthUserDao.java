...
public class AuthUserDao extends AbstractDao<UserEntity, Long> {

    public static final String TABLENAME = "AuthUserInfo";
    ...
    */
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'AuthUserInfo' (" + //
        ...
        // Add Indexes 
        db.execSQL("CREATE INDEX " + constraint + "IDX_AuthUserInfo_PEER_ID ON AuthUserInfo" +
                " (PEER_ID);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'AuthUserInfo'";
        db.execSQL(sql);
    }
