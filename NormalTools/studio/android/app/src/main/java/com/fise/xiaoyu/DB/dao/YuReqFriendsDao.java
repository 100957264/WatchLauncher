...
public class YuReqFriendsDao extends AbstractDao<WeiEntity, Long> {

    public static final String TABLENAME = "YuReqInfo";
    ...
    */
    ...
    public YuReqFriendsDao(DaoConfig config) {
        super(config);
    }

    public YuReqFriendsDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'YuReqInfo' (" + //
        ...
        // Add Indexes 
        db.execSQL("CREATE INDEX " + constraint + "IDX_YuReqInfo_PEER_ID ON YuReqInfo" +
                " (FROM_ID);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'YuReqInfo'";
        db.execSQL(sql);
    }
