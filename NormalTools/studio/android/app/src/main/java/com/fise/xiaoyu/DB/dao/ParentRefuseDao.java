...
public class ParentRefuseDao extends AbstractDao<WeiEntity, Long> {

    public static final String TABLENAME = "ParentRefuseDao";
    ...
    */
    ...
    public static class Properties {
        ...
        public final static Property device_id = new Property(7, int.class, "device_id", false, "DEVICE_ID");
        public final static Property masgData = new Property(8, String.class, "masgData", false, "MASGDATA");

    };

    public ParentRefuseDao(DaoConfig config) {
        super(config);
    }

    public ParentRefuseDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'ParentRefuseDao' (" + //
        		...
        		"'MASGDATA' TEXT NOT NULL );");  // 8: masgData
        
        
        // Add Indexes 
        db.execSQL("CREATE INDEX " + constraint + "IDX_ParentRefuseDao_PEER_ID ON ParentRefuseDao" +
                " (FROM_ID);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'ParentRefuseDao'";
        db.execSQL(sql);
    }
    ...
    protected void bindValues(SQLiteStatement stmt, WeiEntity entity) {
        ...
        stmt.bindString(9, entity.getMasgData());
    }
    ...
    public WeiEntity readEntity(Cursor cursor, int offset) {
    	WeiEntity entity = new WeiEntity( //
            ...
            cursor.getInt(offset + 6), // Updated
                cursor.getInt(offset + 7), // device_id
            cursor.getString(offset + 8) // data
        );
    ...
    public void readEntity(Cursor cursor, WeiEntity entity, int offset) {
        ...
        entity.setDevice_id(cursor.getInt(offset + 7));
        entity.setMasgData(cursor.getString(offset + 8));
