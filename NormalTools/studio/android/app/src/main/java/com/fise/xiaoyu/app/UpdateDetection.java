...
public class UpdateDetection {
    ...
    public UpdateDetection(Context context,String url) {
        ...
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            ...
            saveFileName = savePath + "/xiaowei.apk";
        }
    }
    ...
    public void showNoticeDialog(){
        ...
        final FilletDialog myDialog = new FilletDialog(mContext ,FilletDialog.FILLET_DIALOG_TYPE.FILLET_DIALOG_WITH_MESSAGE);
        myDialog.setTitle("软件更新");
        myDialog.setMessage("软件版本更新");//设置内容
        myDialog.dialog.show();//显示
        myDialog.setRight("下载");
