...
public interface SysConstant {
    ...
    public static final String UPLOAD_IMAGE_INTENT_PARAMS_TYPE = "com.fise.xiaoyu.upload.image.intent.type";
    public static final String UPLOAD_IMAGE_INTENT_PARAMS = "com.fise.xiaoyu.upload.image.intent";
    public static final String UPLOAD_IMAGE_INTENT_PARAMS_AVATAR = "com.fise.xiaoyu.upload.image.avatar.intent";
    public static final String UPLOAD_VEDIO_INTENT_PARAMS = "com.fise.xiaoyu.upload.vedio.intent";
    public static final String UPLOAD_IMAGE_END_INTENT_PARAMS = "com.fise.xiaoyu.upload.image.end.intent";
    public static final String UPLOAD_IMAGE_INTENT_TYPE_AVATAR = "com.fise.xiaoyu.upload.image.type.intent";
    ...
    public static final int MESSAGE_EVENTBUS_PRIORITY_VEDIO = 101;
