	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		select_photograph.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				requestRunPermisssion(Manifest.permission.CAMERA, new AppBaseActivity.PermissionListener() {
					@Override
					protected void onGranted() {
						File file = new File(Environment.getExternalStorageDirectory(), PHOTO_FILE_NAME);
						CompatUtil.startActionCapture(SettingMessageBgActivity.this, file, PHOTO_REQUEST_CAMERA);
					}

					@Override
					protected void onDenied(List<String> deniedPermission) {
						Toast.makeText(SettingMessageBgActivity.this, PermissionUtil.getPermissionString(SettingMessageBgActivity.this, deniedPermission), Toast.LENGTH_SHORT).show();
					}
				});
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (requestCode == PHOTO_REQUEST_GALLERY) {
			if (data != null) {
				...
				String path = null;
				if(uri != null){
					File file = CompatUtil.getFileForUri(this,uri);
					if (file != null) {
			...
			if ( data != null) {
				...
				this.photo = BitmapFactory.decodeFile(tempfile.getPath());
			}
