 ...
 * 父母信息表
*/
public class ParentUserDao extends AbstractDao<UserEntity, Long> {

    public static final String TABLENAME = "ParentUserDao";
    ...
    */
    ...
    public ParentUserDao(DaoConfig config) {
        super(config);
    }

    public ParentUserDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'ParentUserDao' (" + //
        ...
        // Add Indexes 
        db.execSQL("CREATE INDEX " + constraint + "IDX_ParentUserDao_PEER_ID ON ParentUserDao" +
                " (PEER_ID);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'ParentUserDao'";
        db.execSQL(sql);
    }
