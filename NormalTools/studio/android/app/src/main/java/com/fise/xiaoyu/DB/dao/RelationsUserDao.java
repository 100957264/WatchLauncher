...
public class RelationsUserDao extends AbstractDao<UserEntity, Long> {

    public static final String TABLENAME = "RelationsUserInfo";
    ...
    */
    public static class Properties {
        ...
        public final static Property locationType = new Property(30, int.class, "locationType", false, "LOCATIONTYPE");
        public final static Property weight = new Property(31, int.class, "weight", false, "WEIGHT");
        public final static Property height = new Property(32, int.class, "height", false, "HEIGHT");
        public final static Property birthday = new Property(33, String.class, "birthday", false, "BIRTHDAY");


    };
 

    public RelationsUserDao(DaoConfig config) {
        super(config);
    }
    
    public RelationsUserDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'RelationsUserInfo' (" + //
                ...
                "'GROUPNICK' TEXT NOT NULL ," + // 29: groupNick
                "'LOCATIONTYPE' INTEGER NOT NULL ," + // 30:locationType
                "'WEIGHT' INTEGER NOT NULL ," + // 31: weight
                "'HEIGHT' INTEGER NOT NULL ," + // 32: height
                "'BIRTHDAY' INTEGER NOT NULL );");  // 33:birthday
        
        // Add Indexes 
        db.execSQL("CREATE INDEX " + constraint + "IDX_RelationsUserInfo_PEER_ID ON RelationsUserInfo" +
                " (PEER_ID);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'RelationsUserInfo'";
        db.execSQL(sql);
    }
    ...
    protected void bindValues(SQLiteStatement stmt, UserEntity entity) {
        ...
        stmt.bindLong(31, entity.getLocationType());
        stmt.bindLong(32, entity.getWeight());
        stmt.bindLong(33, entity.getHeight());
        stmt.bindString(34, entity.getBirthday());
    }
    ...
    public UserEntity readEntity(Cursor cursor, int offset) {
        UserEntity entity = new UserEntity( //
            ...
            cursor.getInt(offset + 28),//SearchAllow
                ...
                cursor.getInt(offset + 30),  //locationType
                cursor.getInt(offset + 31),  //weight
                cursor.getInt(offset + 32),  //height
                cursor.getString(offset + 33)  //birthday
    ...
    public void readEntity(Cursor cursor, UserEntity entity, int offset) {
        ...
        entity.setLocationType(cursor.getInt(offset + 30));
        entity.setWeight(cursor.getInt(offset + 31));
        entity.setHeight(cursor.getInt(offset + 32));
        entity.setBirthday(cursor.getString(offset + 33));
     }
