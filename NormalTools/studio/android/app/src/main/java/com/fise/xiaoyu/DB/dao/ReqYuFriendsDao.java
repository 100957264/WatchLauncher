 ...
 * 雨友请求 table角 表
*/
public class ReqYuFriendsDao extends AbstractDao<ReqFriendsEntity, Long> {

    public static final String TABLENAME = "ReqYuFriendsDao";
    ...
    */
    ...
    public ReqYuFriendsDao(DaoConfig config) {
        super(config);
    }

    public ReqYuFriendsDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'ReqYuFriendsDao' (" + //
        ...
        // Add Indexes 
        db.execSQL("CREATE INDEX " + constraint + "IDX_ReqYuFriendsDao_USER_ID ON ReqYuFriendsDao" +
                " (USER_ID);");
    }
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'ReqYuFriendsDao'";
        db.execSQL(sql);
    }
