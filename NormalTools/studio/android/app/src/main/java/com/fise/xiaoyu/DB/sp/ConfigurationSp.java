 ...
 */
@SuppressLint("NewApi") public class ConfigurationSp {
    private Context ctx;
    private int loginId;
    ...
    public void setCfg(String key, CfgDimension dimension, boolean onoff) {
        ...
        EventBus.getDefault().post(SessionEvent.SET_SESSION_NO_DISTURB);
    }

    public String getStrCfg(String key){

       return  sharedPreferences.getString(key , "");
    }

    public void setStrCfg(String key, String vaule){
        SharedPreferences.Editor editor = sharedPreferences.edit();
