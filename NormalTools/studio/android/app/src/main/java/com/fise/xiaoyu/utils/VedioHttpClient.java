...
public class VedioHttpClient {

	private static Logger logger = Logger.getLogger(VedioHttpClient.class);

	public static String uploadImage3(String strUrl, byte[] bytes, String fileName) {
