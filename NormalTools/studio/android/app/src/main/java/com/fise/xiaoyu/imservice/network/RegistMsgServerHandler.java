package com.fise.xiaoyu.imservice.network;
...
public class RegistMsgServerHandler extends SimpleChannelHandler {

    private Logger logger = Logger.getLogger(RegistMsgServerHandler.class);
	...
	public void channelConnected(ChannelHandlerContext ctx, ChannelStateEvent e)
        ...
        IMSocketManager.instance().onRegistMsgServerConnected();
	}
