...
public interface MessageConstant {
    ...
    public final int  IMAGE_LOADED_OVERDUE =5;

    public final int  IMAGE_VEDIO_LOADED_SUCCESS =5;

    
    /**图片消息状态，表示下载到本地、上传到服务器的状态*/
    public final int  VEDIO_UNLOAD=1;
    public final int  VEDIO_LOADING=2;
    public final int  VEDIO_LOADED_SUCCESS =3;
    public final int  VEDIO_LOADED_FAILURE =4;
