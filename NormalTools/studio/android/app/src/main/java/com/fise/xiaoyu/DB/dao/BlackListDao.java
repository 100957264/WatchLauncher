...
public class BlackListDao extends AbstractDao<UserEntity, Long> {

    public static final String TABLENAME = "BlackListDao";
    ...
    */
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'BlackListDao' (" + //
        ...
        // Add Indexes 
        db.execSQL("CREATE INDEX " + constraint + "IDX_BlackListDao_PEER_ID ON BlackListDao" +
                " (PEER_ID);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'BlackListDao'";
        db.execSQL(sql);
    }
