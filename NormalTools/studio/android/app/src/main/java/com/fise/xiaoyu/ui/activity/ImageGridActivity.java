...
import com.fise.xiaoyu.ui.adapter.album.ImageGridAdapter;
import com.fise.xiaoyu.ui.adapter.album.ImageGridAdapter.TextCallback;
 ...
 * 相册图片列表
 */
public class ImageGridActivity extends TTBaseActivity implements OnTouchListener {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    Utils.showToast(ImageGridActivity.this,
        ...
        finish.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (adapter.getSelectMap().size() > 0) {
                    ...
                    Utils.showToast(ImageGridActivity.this,
                           ImageGridActivity.this.getString( R.string.need_choose_images));
                }
            }
