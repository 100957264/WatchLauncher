...
public class GroupWeiDao extends AbstractDao<GroupEntity, Long> {

    public static final String TABLENAME = "GroupWeiInfo";
    ...
    */
    public static class Properties {
        ...
        public final static Property Save = new Property(12, int.class, "save", false, "SAVE");
        
        public final static Property Board = new Property(13, String.class, "Board", false, "BOARD");
        public final static Property Board_Time  = new Property(14, String.class, "Board_Time", false, "BOARD_TIME");
         
        
    };


    public GroupWeiDao(DaoConfig config) {
        super(config);
    }
    
    public GroupWeiDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'GroupWeiInfo' (" + //
                ...
                "'SAVE' INTEGER NOT NULL ," + // 12: SAVE
                "'BOARD' TEXT NOT NULL ," + // 13: BOARD 
                "'BOARD_TIME' TEXT NOT NULL );"); // 13: BOARD_TIME
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'GroupWeiInfo'";
        db.execSQL(sql);
    }
    ...
    protected void bindValues(SQLiteStatement stmt, GroupEntity entity) {
        ...
        stmt.bindLong(13, entity.getSave());
        stmt.bindString(14, entity.getBoard());
        stmt.bindString(15, entity.getBoardTime());
    ...
    public GroupEntity readEntity(Cursor cursor, int offset) {
        GroupEntity entity = new GroupEntity( //
            ...
            cursor.getInt(offset + 12), // save
            cursor.getString(offset + 13), // board
            cursor.getString(offset + 14) // board_time
    ...
    public void readEntity(Cursor cursor, GroupEntity entity, int offset) {
        ...
        entity.setSave(cursor.getInt(offset + 12));
        entity.setBoard(cursor.getString(offset + 13));
        entity.setBoardTime(cursor.getString(offset + 14)); 
