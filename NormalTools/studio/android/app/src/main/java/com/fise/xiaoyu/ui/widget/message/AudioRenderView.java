...
public class AudioRenderView extends  BaseMsgRenderView {
     ...
     */
    @Override
    public void render(final MessageEntity messageEntity,final UserEntity userEntity,final Context ctx,PeerEntity peerEntity) {
        ...
        messageLayout.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!new File(audioPath).exists()) {
                    Utils.showToast(ctx, ctx.getResources().getString(R.string.notfound_audio_file));
                    return;
                }
