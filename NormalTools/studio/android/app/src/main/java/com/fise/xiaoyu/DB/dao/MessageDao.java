...
public class MessageDao extends AbstractDao<MessageEntity, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property isDelete = new Property(11, int.class, "isDelete", false, "ISDELETE"); 
        
        public final static Property showType = new Property(12, int.class, "showType", false, "SHOWTYPE"); 
        public final static Property sendId = new Property(13, int.class, "sendId", false, "SENDID");  
        public final static Property address = new Property(14, String.class, "address", false, "ADDRESS"); 
        public final static Property messageTime = new Property(15, String.class, "messageTime", false, "MESSAGETIME"); 
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'Message' (" + //
                ...
                "'ISDELETE' INTEGER NOT NULL ," + // 11: isDelete 
                "'SHOWTYPE' INTEGER NOT NULL ," + // 12: SHOWTYPE 
                "'SENDID' INTEGER NOT NULL ," + // 13: SENDID
                "'ADDRESS' TEXT NOT NULL ," + // 14: ADDRESS
                "'MESSAGETIME' TEXT NOT NULL );"); // 15: MESSAGETIME 
        // Add Indexes
    ...
    protected void bindValues(SQLiteStatement stmt, MessageEntity entity) {
        ...
        stmt.bindLong(12, entity.getDelete());  
        
        stmt.bindLong(13, entity.getType()); 
        stmt.bindLong(14, entity.getSendId()); 
        stmt.bindString(15, entity.getAddress()); 
        stmt.bindString(16, entity.getMessageTime()); 
    ...
    public MessageEntity readEntity(Cursor cursor, int offset) {
        MessageEntity entity = new MessageEntity( //
            ...
            cursor.getInt(offset + 11), // delete  
            cursor.getInt(offset + 12), // delete 
            cursor.getInt(offset + 13), // delete  
            cursor.getString(offset + 14), // Address 
            cursor.getString(offset + 15) // time 
        ); //
        //cursor.getString(offset + 15) // PATH 
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, MessageEntity entity, int offset) {
        ...
        entity.setDelete(cursor.getInt(offset + 11));  
        entity.setType(cursor.getInt(offset + 12));
        entity.setSendId(cursor.getInt(offset + 13)); 
        entity.setAddress(cursor.getString(offset + 14));
        entity.setMessageTime(cursor.getString(offset + 15));
