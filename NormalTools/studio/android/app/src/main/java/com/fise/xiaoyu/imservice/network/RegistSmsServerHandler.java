...
public class RegistSmsServerHandler extends SimpleChannelHandler {

    private Logger logger = Logger.getLogger(RegistSmsServerHandler.class);
	...
	public void channelConnected(ChannelHandlerContext ctx, ChannelStateEvent e)
        ...
        IMSocketManager.instance().onRegistSmsServerConnected();
	}
