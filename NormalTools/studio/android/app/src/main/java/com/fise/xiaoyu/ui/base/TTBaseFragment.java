...
import com.fise.xiaoyu.ui.menu.PopMenu;
...
//	protected Button searchFrameButton;
	...
	private boolean autoEventbus = true;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		lineView = topContentView.findViewById(R.id.top_bar_split_line);
...
//		paint.setFakeBoldText(true); 
	...
	public void hideAddFriends() {
		if(	addFriendsFrame!=null){
			addFriendsFrame.setVisibility(View.GONE);
		}
	}
	...
	protected  void hideTopSpliteLine(){
