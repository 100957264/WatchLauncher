...
public class HistoryActivity extends AppCompatActivity {
    ...
    HistoryGestureListener mGestureListener;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initData();
        mGestureListener = new HistoryGestureListener();
    ...
    class HistoryGestureListener implements  GestureDetector.OnGestureListener{
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            if (e1.getX() - e2.getX() > FLING_MIN_DISTANCE
                ...
                // Fling right
                startActivity(new Intent(HistoryActivity.this, SetPlanActivity.class));
