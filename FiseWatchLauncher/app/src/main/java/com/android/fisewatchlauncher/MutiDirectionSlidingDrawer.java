...
public class MutiDirectionSlidingDrawer extends ViewGroup {
     ...
     */
    public MutiDirectionSlidingDrawer( Context context, AttributeSet attrs )
    {
     ...
     */
    public MutiDirectionSlidingDrawer( Context context, AttributeSet attrs, int defStyle )
    {
