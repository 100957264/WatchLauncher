...
import com.fise.marechat.client.helper.decode.AbsDecodeHelper;
import com.fise.marechat.client.helper.decode.BaseDecodeHelper;
import com.fise.marechat.client.helper.stickpackage.AbsStickPackageHelper;
import com.fise.marechat.client.helper.stickpackage.BaseStickPackageHelper;
import com.fise.marechat.client.helper.validation.AbsValidationHelper;
import com.fise.marechat.client.helper.validation.BaseValidationHelper;
...
public class TcpConnConfig {
    ...
    private long connTimeout = 5 * 60 * 1000;//连接超时时间
