...
public final class AppUtils {
    ...
    private AppUtils() {
        throw new UnsupportedOperationException("u can't instantiate " + TAG);
    }
    ...
    public static boolean installAppSilent(final String filePath) {
        ...
        ShellUtils.CommandResult commandResult = ShellUtils.execCommand(command, !isSystemApp(), true);
    ...
    public static String getAppSignatureSHA1(final String packageName) {
        ...
        return AdsEncryptUtils.encryptSHA1ToString(signature[0].toByteArray()).
